...
coreml_model = coremltools.converters.keras.convert('./model_data/yolov3-tiny.h5', input_names='input1', image_input_names='input1', output_names=['output1', 'output2'], image_scale=1/255.)
